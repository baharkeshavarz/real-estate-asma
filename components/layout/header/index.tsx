...
import DropdownLocale from "./dropdown-lacale"
  ...
  return (
    <header className="sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-2 shadow-2 md:px-6 2xl:px-11">
        ...
        <div className="hidden sm:block">
          <form method="POST">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder={t.pages.general.searchLabel}
        ...
        <div className="flex items-center gap-2 2xsm:gap-5">
          <DropdownLocale t={t} />
          <ul className="flex items-center gap-1 2xsm:gap-2">
            <DropdownNotification />
          </ul>
          <DropdownUser t={t} profileData={profileData} />
        </div>
      </div>
    </header>
  )
