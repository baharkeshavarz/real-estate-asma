...
const DropdownLocale = ({ t }: DropdownLocaleProps) => {
  ...
  const redirectToLanguage = (locale: string) => {
    ...
    segments[1] = locale
    // Change the lang for server
    authHandler.setLanguage(locale)
  ...
  return (
    <div className="relative z-20 bg-white dark:bg-form-input">
      ...
      <select
        ...
        className={`relative z-20 w-full appearance-none rounded border border-stroke bg-transparent px-12 py-3
